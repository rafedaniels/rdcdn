...
local RDLLib = Instance.new("ScreenGui")
RDLLib.Name = "RDLLib"
RDLLib.Parent = game.CoreGui
RDLLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

coroutine.wrap(
	function()
		while wait() do
			RDL.RainbowColorValue = RDL.RainbowColorValue + 1 / 255
			RDL.HueSelectionPosition = RDL.HueSelectionPosition + 1

			if RDL.RainbowColorValue >= 1 then
				RDL.RainbowColorValue = 0
			end

			if RDL.HueSelectionPosition == 80 then
				RDL.HueSelectionPosition = 0
			end
		end
	end
)()
...
function RDL:Window(text, bottom,mainclr,toclose)
	...
	function RDL:Notification(desc,buttontitle)
				...
				function()
					...
					if RainbowColorPicker then
						...
						while RainbowColorPicker do
							BoxColor.BackgroundColor3 = Color3.fromHSV(RDL.RainbowColorValue, 1, 1)
							Color.BackgroundColor3 = Color3.fromHSV(RDL.RainbowColorValue, 1, 1)

							ColorSelection.Position = UDim2.new(1, 0, 0, 0)
							HueSelection.Position = UDim2.new(0.48, 0, 0, RDL.HueSelectionPosition)
